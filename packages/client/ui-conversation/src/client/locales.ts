...
export const zh = {
  ...
  'chat.toBottom': '回到底部',
  'chat.promptNav': '对话导航',
  'chat.promptNav.empty': '空消息',
  'chat.promptNav.images': '{count} 张图片',
  'process.processed': '已处理 {duration}',
...
export const en = {
  ...
  'chat.promptNav': 'Conversation navigation',
  'chat.promptNav.empty': 'Empty message',
  'chat.promptNav.images': '{count} images',
  'process.processed': 'Processed {duration}',
